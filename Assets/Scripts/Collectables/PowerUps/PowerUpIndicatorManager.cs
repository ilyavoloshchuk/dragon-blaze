...
namespace Collectables.PowerUps
{
    public class PowerUpIndicatorManager : MonoBehaviour
    {
        ...
        private const float MaxIndicatorWidth = 200f;
        ...
        private void UpdateIndicatorPositions()
        {
            ...
            foreach (GameObject indicator in activeIndicators)
            {
                ...
                float indicatorWidth = Mathf.Min(LayoutUtility.GetPreferredWidth(textComponent.rectTransform), MaxIndicatorWidth);
